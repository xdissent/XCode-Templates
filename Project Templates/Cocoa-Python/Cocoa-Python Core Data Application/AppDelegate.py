...
class ÇPROJECTNAMEASIDENTIFIERÈ_AppDelegate(NSObject):
    window = IBOutlet()
    ...
    def applicationSupportFolder(self):
        ...
        return os.path.join(basePath, "ÇPROJECTNAMEASIDENTIFIERÈ")
    ...
    def persistentStoreCoordinator(self):
        ...
        storePath = os.path.join(applicationSupportFolder, "ÇPROJECTNAMEASIDENTIFIERÈ.xml")
